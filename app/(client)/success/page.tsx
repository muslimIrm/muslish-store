  ...
  return (
    <div className="py-10 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-white rounded-2xl shadow-2xl px-8 py-12 max-w-xl w-full text-center space-y-4"
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <Link
            href="/orders"
            className="flex items-center justify-center px-4 py-3 font-semibold bg-white text-black rounded-lg hover:bg-gray-100 border border-black  transition-all duration-300 shadow-md"
          >
